...
const initLayer = (alertUrl, countyUrl, regionUrl) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const each of json.features) {
        ...
        response = yield fetch(`${url}/query?where=${encodeURIComponent(where)}&outFields=${outFields}&returnGeometry=true&outSR=3857&f=pjson`);
        ...
        if (!json.features || json.features.length === 0) {
            ...
            const areaGeom = Polygon_1.default.fromJSON(json.features[0].geometry);
...
const centerFeatures = (mapExtent) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const editResult = yield layer.applyEdits({ updateFeatures: updatedFtrs });
