...
const layerListIcons: IconInfo[] = [
  ...
  <path d="M24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12Z" fill="#0b838b"/>
  <path d="M22.4167 11.8311C22.4167 17.4978 17.7563 22.0976 12 22.0976C6.24369 22.0976 1.58334 17.4978 1.58334 11.8311C1.58334 6.16437 6.24369 1.56458 12 1.56458C17.7563 1.56458 22.4167 6.16437 22.4167 11.8311Z" fill="#0b838b" stroke="white" stroke-width="0.5"/>
  ...
  <path d="M6.76666 8.48317C6.76666 8.23449 6.99116 8.04608 7.23607 8.08923L19.5694 10.2625C19.7606 10.2961 19.9 10.4623 19.9 10.6564V13.0057C19.9 13.1998 19.7606 13.3659 19.5694 13.3996L7.23607 15.5729C6.99116 15.616 6.76666 15.4276 6.76666 15.1789V8.48317Z" fill="#0b838b" stroke="white" stroke-width="0.2"/>
...
<path d="M11.4967 13.3131C11.4264 13.415 11.3888 13.5348 11.3888 13.6574C11.3891 13.8216 11.4567 13.9791 11.5767 14.0952C11.6968 14.2114 11.8594 14.2768 12.0292 14.2771C12.1558 14.2771 12.2796 14.2407 12.385 14.1726C12.4903 14.1046 12.5723 14.0078 12.6208 13.8945C12.6693 13.7813 12.682 13.6567 12.6573 13.5365C12.6325 13.4163 12.5716 13.3058 12.482 13.2192C12.3924 13.1325 12.2783 13.0735 12.1541 13.0496C12.0299 13.0257 11.9011 13.0379 11.7841 13.0848C11.6671 13.1317 11.5671 13.2112 11.4967 13.3131Z" fill="#00398E"/>
  ...
  {
    id: "road-alert-highest",
    paths: `<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" width="24" height="24" viewBox="0 0 24 24" fill="none" version="1.1" id="svg1390" sodipodi:docname="Alert Icon Highest.svg" inkscape:version="0.92.3 (2405546, 2018-03-11)">
    <metadata id="metadata1396">
      <rdf:RDF>
        <cc:Work rdf:about="">
          <dc:format>image/svg+xml</dc:format>
    ...
    <defs id="defs1394"/>
    <sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="1920" inkscape:window-height="986" id="namedview1392" showgrid="false" inkscape:zoom="9.7890095" inkscape:cx="8.5593531" inkscape:cy="5.3317258" inkscape:window-x="-11" inkscape:window-y="-11" inkscape:window-maximized="1" inkscape:current-layer="svg1390"/>
    <path d="M24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12Z" id="path1382" style="fill:#ffc107;fill-opacity:1" fill="#FF6A13"/>
    <path d="M22.4167 11.8316C22.4167 17.4986 17.7563 22.0986 12 22.0986C6.2437 22.0986 1.58334 17.4986 1.58334 11.8316C1.58334 6.16464 6.2437 1.56464 12 1.56464C17.7563 1.56464 22.4167 6.16464 22.4167 11.8316Z" fill="#FF6A13" stroke="white" stroke-width="0.5" id="path1384" style="fill:#b30b00;fill-opacity:1"/>
    <path d="M11.5747 14.3438H12.3109C12.8632 14.3438 13.3109 13.8961 13.3109 13.3438V5.99536C13.3109 5.44308 12.8632 4.99536 12.3109 4.99536H11.5747C11.0225 4.99536 10.5747 5.44308 10.5747 5.99536V13.3438C10.5747 13.8961 11.0225 14.3438 11.5747 14.3438Z" fill="white" id="path1386"/>
    <path d="M10.8144 16.9406C10.6581 17.1602 10.5747 17.4184 10.5747 17.6825C10.5755 18.0365 10.7256 18.3758 10.9921 18.6261C11.2587 18.8764 11.62 19.0173 11.997 19.018C12.2782 19.018 12.5532 18.9397 12.7871 18.7929C13.021 18.6462 13.2033 18.4376 13.3109 18.1936C13.4186 17.9496 13.4467 17.681 13.3919 17.422C13.337 17.1629 13.2015 16.925 13.0026 16.7382C12.8037 16.5514 12.5503 16.4242 12.2744 16.3727C11.9985 16.3212 11.7126 16.3476 11.4527 16.4487C11.1928 16.5498 10.9707 16.7209 10.8144 16.9406Z" fill="white" id="path1388"/>
  </svg>`
  },
  ...
  },
  {
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M16.4042 4.1C16.4812 3.96667 16.6737 3.96667 16.7506 4.1L19.2039 8.34911C19.2809 8.48244 19.1846 8.64911 19.0307 8.64911H17.224V16.531C17.224 16.6414 17.1344 16.731 17.024 16.731H16.1309C16.0204 16.731 15.9309 16.6414 15.9309 16.531V8.64911H14.1242C13.9703 8.64911 13.874 8.48244 13.951 8.34911L16.4042 4.1Z" fill="white"/>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.0803 7.67929C6.96984 7.67929 6.8803 7.76883 6.8803 7.87929V14.468H5.07362C4.91966 14.468 4.82343 14.6347 4.90041 14.768L7.35364 19.0172C7.43062 19.1505 7.62307 19.1505 7.70005 19.0172L10.1533 14.768C10.2303 14.6347 10.134 14.468 9.98007 14.468H8.17339V7.87929C8.17339 7.76883 8.08385 7.67929 7.97339 7.67929H7.0803Z" fill="white"/>
...
const otherIcons: IconInfo[] = [
  ...
  },
  {
    ...
    paths: `<svg width="36" height="36" fill="none" version="1.1" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
    <circle cx="18" cy="18" r="18" fill="#dc3545" stroke-width="1.5"/>
    <path d="m33.553 17.538c0 8.319-6.9471 15.092-15.554 15.092-8.6067 0-15.554-6.7734-15.554-15.092 0-8.319 6.9472-15.092 15.554-15.092 8.6067 0 15.554 6.7733 15.554 15.092z" fill="#dc3545" stroke="#fff" stroke-width=".48"/>
    <rect transform="rotate(45)" x="18.97" y="-6.4854" width="13.199" height="13.199" rx=".75" fill="#fff" stroke-width="1.5"/>
    <rect transform="rotate(45)" x="17.346" y="-8.1103" width="16.221" height="16.221" rx=".375" stroke="#fff" stroke-width=".3"/>
    <path d="m17.056 13.688v5.3659c0 0.60105 0.48735 1.0882 1.0884 1.0882s1.0882-0.4872 1.0882-1.0882v-5.3659c0-0.60106-0.4872-1.0883-1.0882-1.0883s-1.0884 0.48724-1.0884 1.0883z" fill="#dc3545" stroke-width="1.5"/>
