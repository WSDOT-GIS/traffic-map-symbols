    ...
    <ul class="w3-ul">
      ...
      <li class="w3-border-0 mapFeaturesLI" style="padding: 1px 0">
        <ToggleSwitchView
          @toggle="clickEvent"
          :Checked="
            layerList[getLayerIndex('point-restrictions-layer')].visible
          "
          :Value="
      ...
      <li class="w3-border-0 mapFeaturesLI" style="padding: 1px 0">
        ...
        >
          <template v-slot>
            ...
            <span class="listLabel">
              {{
                layerList[getLayerIndex("mountain-passes-layer")].title
              }}</span
            >
          </template>
        </ToggleSwitchView>
      ...
      <li class="w3-border-0 mapFeaturesLI" style="padding: 1px 0">
        ...
        >
          <template v-slot>
            ...
            <span class="listLabel">
              {{
                layerList[getLayerIndex("weather-stations-layer")].title
              }}</span
            >
          </template>
        </ToggleSwitchView>
      ...
      <li class="w3-border-0 mapFeaturesLI" style="padding: 1px 0">
        <ToggleSwitchView
          ...
          :Title="
            'Toggle ' + layerList[getLayerIndex('mile-markers-layer')].title
          "
        >
          <template v-slot>
            <div
